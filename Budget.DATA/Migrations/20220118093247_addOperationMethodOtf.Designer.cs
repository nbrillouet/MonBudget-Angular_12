...
namespace Budget.DATA.Migrations
{
    ...
    [Migration("20220118093247_addOperationMethodOtf")]
    partial class addOperationMethodOtf
    {
            ...
            modelBuilder.Entity("Budget.MODEL.Database.OperationMethodOtf", b =>
                {
                    ...
                    b.Property<int?>("OperationMethodId")
                        .HasColumnType("int");

                    b.Property<int?>("OperationTypeFamilyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OperationTypeFamilyId");

                    b.ToTable("OperationMethodOtf");
                });
            ...
            modelBuilder.Entity("Budget.MODEL.Database.OperationMethodOtf", b =>
                {
                    ...
                    b.HasOne("Budget.MODEL.Database.OperationTypeFamily", "OperationTypeFamily")
                        .WithMany()
                        .HasForeignKey("OperationTypeFamilyId");
