...
// import { FilterForDetail, Select, SelectCode, SelectGroup } from '@corporate/model';
...
//           return this._httpClient
//             .post<any>(`${this.baseUrl}referential/operation-type-families/filter`, filter);
//         }

//         getOtfTableFilter(filter: FilterOtfTableSelected): Observable<FilterOtfTableSelection> {
//           return this._httpClient
//                 .post<FilterOtfTableSelection>(`${this.baseUrl}referential/operation-type-families/table-filter`, filter);
//         }
